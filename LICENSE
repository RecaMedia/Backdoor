...
*   Parts of the software are provided under separate licenses, as follows:
    ...
    jQuery, ReactJS, CodeMirror, DirectoryLister, Socket.io


## Backdoor Code Editor - Terms and conditions

1.  **Preamble:** This Agreement, signed on Nov 22, 2017 (hereinafter: Effective Date) governs the relationship between User, a Business Entity, (hereinafter: Licensee) and RecaMedia LLC, a duly registered company in whose principal place of business is Orlando (hereinafter: Licensor). This Agreement sets the terms, rights, restrictions and obligations on using Backdoor Code Editor (hereinafter: The Software) created and owned by Licensor, as detailed herein
...
For more information, please refer to <https://www.binpress.com/license/view/l/e0c6639c0e71342485d8ff9877229ec4>
