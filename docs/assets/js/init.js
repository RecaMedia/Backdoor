...
},{"./modules/nav":2,"jquery":3}],2:[function(require,module,exports){
'use strict';
...
var Nav = exports.Nav = function () {
	function Nav(options) {
		...
		this.options = _jquery2.default.extend({}, this.defaults(), this.options);
		this.delegateEvents();
	}
	...
	_createClass(Nav, [{
		...
		value: function delegateEvents() {
			...
			var $html = (0, _jquery2.default)('html, body');
